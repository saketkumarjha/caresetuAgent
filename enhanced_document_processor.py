...
from vector_store import ChromaVectorStore, CompanyConfig, DocumentChunk
...
class EnhancedDocumentProcessor:
    ...
    async def process_company_pdf(self, company_id: str, pdf_path: Path, 
        ...
        """
        Process PDF document for a company with ChromaDB integration.
        ...
        success = await self.vector_store.add_document_chunks(company_id, document_chunks)
...
async def test_enhanced_processor():
    ...
    vector_store = ChromaVectorStore("./test_enhanced_chroma")
    
    # Register company
    company_config = CompanyConfig(
        company_id="enhanced_test",
        company_name="Enhanced Test Corp",
        collection_prefix="enhanced_test"
    )
    vector_store.register_company(company_config)
    
    # Initialize processor
    processor = EnhancedDocumentProcessor(vector_store)
