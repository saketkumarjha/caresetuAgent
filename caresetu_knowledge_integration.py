...
class CareSetuKnowledgeEnhancer:
    ...
    async def _add_structured_faqs(self):
        ...
        faqs = [
            ...
            },
            {
                ...
                "answer": "You can contact our support team at sales@akhilsystems.com or through the Help section in the CareSetu App.",
                "category": "support"
            },
            {
    ...
    async def _add_business_information(self):
        ...
        business_info = {
            ...
            - Contact: sales@akhilsystems.com
